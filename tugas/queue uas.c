...
int main() {
    ...
    enqueue(&queue, "Alice", "B001");
    enqueue(&queue, "Bob", "B002");
    enqueue(&queue, "Charlie", "B003");

    // Memindahkan data dari queue ke riwayat
    pindahkanQueueKeRiwayat(&queue, &riwayat);

    printf("\n--- Menampilkan Semua Riwayat ---\n");
    tampilkanRiwayat(&riwayat);

    printf("\n--- Mencari Peminjam Buku Berdasarkan ID ---\n");
    cariPeminjamBuku(&riwayat, "B002");
    cariPeminjamBuku(&riwayat, "B004");
